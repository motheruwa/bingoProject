...
function Card73() {
  ...
  const checkWin = () => {
    const winConditions = [
      ["B8", "B9", "B12", "B3", "B6"], // First row (B)
      ["I17", "I26", "I19", "I24", "I28"], // Second row (I)
      ["N43", "N38", "free", "N36", "N44"], // Third row (N)
      ["G50", "G57", "G47", "G49", "G60"], // Fourth row (G)
      ["O65", "O75", "O68", "O63", "O64"], // Fifth row (O)
      ["B8", "I26", "free", "G49", "O64"], // Top-left to bottom-right diagonal
      ["O65", "G57", "free", "I24", "B6"], // Top-right to bottom-left diagonal
      ["B8", "I17", "N43", "G50", "O65"], // First column
      ["B9", "I26", "N38", "G57", "O75"], // Second column
      ["B12", "I19", "free", "G47", "O68"], // Third column
      ["B3", "I24", "N36", "G49", "O63"], // Fourth column
      ["B6", "I28", "N44", "G60", "O64"], // Fifth column
      ["B8", "B6", "O65", "O64"],
    ];
    const winningLines = [];
