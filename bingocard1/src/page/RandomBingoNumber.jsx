  ...
  const GenerateBingoNumber6 = () => {
    ...
    const GenerateBingoNumber7 = () => {
      const sequence = [
        ...
        'O71', 'O73', 'G54', 'I23', 'O65', 'I19', 'N43', 'G46', 'B13', 'N44', 'G56', 'I16', 'B7', 'I29', 'O66',
        'N31', 'O61', 'B10', 'G60', 'O72', 'G57',  'O63', 'B14', 'O70', 'B1', 'B3', 'G53', 'O75', 'N45','I26',
        'O69', 'N34', 'I22', 'O67', 'N32', 'G55', 'G52', 'N41', 'O62', 'B4', 'I18', 'O74', 'B5', 'B6', 'I25',
         'I17', 'N33', 'G47', 'N37', 'B2', 'N35', 'I27', 'I20', 'N39', 'N42', 'I24', 'B12', 'B11', 'N38','B9'
      ];
      let sequenceIndex = localStorage.getItem('sequenceIndex');
      if (sequenceIndex === null) {
        sequenceIndex = 0;
    ...
    const GenerateBingoNumber8 = () => {
      const sequence = [
        ...
        'B2', 'G53', 'G54', 'N43', 'O65', 'G49', 'B13', 'O66', 'I23', 'N44', 'G56', 'I16', 'B14', 'I29', 'G46',
        'G59', 'I21', 'B10', 'G60', 'O72', 'G57',  'O63', 'O70', 'O68', 'B4', 'B5', 'O73', 'O75', 'N42','G48',
        'B15', 'B9', 'I22', 'G51', 'N32', 'G55', 'G52', 'N41', 'O62', 'B1', 'I30', 'O74', 'B3', 'B6', 'I25',
         'I17', 'N33', 'G47', 'N37', 'O71', 'N35', 'I27', 'I20', 'B12', 'I18', 'I24', 'N34', 'G58', 'N38','N31'
      ];
      let sequenceIndex = localStorage.getItem('sequenceIndex');
      if (sequenceIndex === null) {
        sequenceIndex = 0;
    ...
    const GenerateBingoNumber9 = () => {
      const sequence = [
        'N33', 'G55', 'B8', 'O62', 'G54', 'N44', 'B2', 'O72', 'N42', 'B11', 'N40', 'N45', 'O67', 'G50', 'N39',
        'I28', 'G53', 'O65', 'B13', 'I18', 'G49', 'N43', 'O66', 'I23', 'I19', 'G56', 'I16', 'B14', 'I29', 'G58',
        'N31', 'I21', 'G57', 'G60', 'O61', 'B10',  'O63', 'O70', 'B5', 'N38', 'G46', 'O73', 'B15', 'I26','B9',
        'O75', 'B12', 'I22', 'G51', 'N32', 'O69', 'G52', 'N41', 'N36', 'B4', 'I30', 'O74', 'B3', 'B6', 'I25',
         'I17', 'B7', 'G47', 'N37', 'O71', 'N35', 'I27', 'I20', 'O64', 'G48', 'I24', 'N34', 'O68', 'B1','G59'
      ];
      let sequenceIndex = localStorage.getItem('sequenceIndex');
      if (sequenceIndex === null) {
        sequenceIndex = 0;
    ...
    const GenerateBingoNumber10 = () => {
      const sequence = [
        ...
        'I28', 'I23', 'I18', 'G49', 'O65', 'G48', 'N43', 'O66', 'G53', 'I19', 'G56', 'I16', 'B14', 'I29', 'G46',
        'O73', 'I21', 'B10', 'G60', 'O69', 'G50',  'O63', 'O72', 'N44', 'B1', 'B5', 'N31', 'G55', 'I26','B9',
        'B15', 'B12', 'I22', 'G51', 'N32', 'O61', 'G52', 'N41', 'N36', 'B4', 'I30', 'O74', 'B3', 'B6', 'I25',
         'I17', 'N33', 'G47', 'N39', 'O71', 'N35', 'I27', 'I20', 'O64', 'B13', 'I24', 'N34', 'O68', 'N40','N44'
      ];
      let sequenceIndex = localStorage.getItem('sequenceIndex');
      if (sequenceIndex === null) {
        sequenceIndex = 0;
    ...
    const GenerateBingoNumber11 = () => {
      const sequence = [
        ...
        'N37', 'O63', 'I18', 'O68', 'O62', 'G49', 'G58', 'O66', 'G53', 'I19', 'G56', 'I16', 'N43', 'I29', 'G46',
        'N31', 'I21', 'B10', 'G60', 'O61', 'G50',  'I23', 'O65', 'B14', 'B1', 'O67', 'O75', 'G55', 'I26','B9',
        'B15', 'B12', 'I22', 'G51', 'N32', 'O69', 'G52', 'B8', 'N36', 'B7', 'I30', 'O74', 'B3', 'B6', 'I25',
         'I17', 'N33', 'G47', 'N39', 'G57', 'N35', 'I27', 'I20', 'G54', 'B13', 'N45', 'N34', 'G48', 'N40','I28'
      ];
      let sequenceIndex = localStorage.getItem('sequenceIndex');
      if (sequenceIndex === null) {
        sequenceIndex = 0;
    ...
    const GenerateBingoNumber12 = () => {
      const sequence = [
        ...
        'I28', 'O63', 'N43', 'O68', 'B12', 'G49', 'B14', 'O66', 'G53', 'I19', 'N45', 'I16', 'G48', 'I29', 'G46',
        'N31', 'I20', 'B10', 'G60', 'O61', 'G50',  'I23', 'O65', 'I22', 'B1', 'O67', 'O75', 'G55', 'B11','O64',
        'B15', 'O62', 'G58', 'G51', 'N32', 'O73', 'G52', 'B8', 'N36', 'B7', 'I30', 'O74', 'B3', 'B6', 'I25',
         'I17', 'N33', 'G47', 'O72', 'G57', 'B4', 'I27', 'I21', 'G54', 'B2', 'G56', 'N34', 'I18', 'N40','N37'
      ];
      let sequenceIndex = localStorage.getItem('sequenceIndex');
      if (sequenceIndex === null) {
        sequenceIndex = 0;
    ...
    const GenerateBingoNumber13 = () => {
      const sequence = [
        ...
        'O71', 'O64', 'N43', 'I23', 'B12', 'N31', 'B13', 'O66', 'G53', 'I19', 'G56', 'I16', 'I18', 'I29', 'G46',
        'G49', 'I21', 'B10', 'G60', 'N37', 'G50',  'O69', 'O65', 'G58', 'B1', 'O67', 'O75', 'G55', 'B11','O63',
        'B15', 'O62', 'I22', 'N35', 'N32', 'B5', 'G52', 'B8', 'N36', 'B7', 'I30', 'O74', 'B3', 'B6', 'I25',
         'I17', 'N33', 'G47', 'O72', 'G57', 'B4', 'I27', 'I20', 'G54', 'B2', 'N39', 'N34', 'N44', 'N42','O61'
      ];
      let sequenceIndex = localStorage.getItem('sequenceIndex');
      if (sequenceIndex === null) {
        sequenceIndex = 0;
    ...
    const GenerateBingoNumber14 = () => {
      const sequence = [
        ...
        'O74', 'G57', 'O64', 'I23', 'B13', 'N31', 'O65', 'O66', 'G53', 'I19', 'G56', 'I16', 'I18', 'I29', 'G58',
        'G49', 'N33', 'O70', 'G60', 'N37', 'G50',  'O69', 'N43', 'G46', 'B5', 'B9', 'O75', 'G55', 'B11','O63',
        'B15', 'O62', 'I22', 'N35', 'N32', 'B1', 'G52', 'B8', 'N36', 'O68', 'I30', 'I26', 'B3', 'B6', 'I25',
         'I17', 'I21', 'G47', 'O72', 'B12', 'B4', 'I27', 'I20', 'G59', 'B2', 'N39', 'N34', 'I24', 'N42','G48'
      ];
      let sequenceIndex = localStorage.getItem('sequenceIndex');
      if (sequenceIndex === null) {
        sequenceIndex = 0;
    ...
    const GenerateBingoNumber15 = () => {
      const sequence = [
        ...
        'I23', 'G57', 'O66', 'I30', 'O65', 'N31', 'B13', 'O64', 'G55', 'I19', 'G56', 'O73', 'I18', 'B2', 'G51',
        'G50', 'I21', 'O70', 'B9', 'N37', 'G49',  'O69', 'N43', 'G58', 'N39', 'G60', 'O75', 'G53', 'B11','O63',
        'B15', 'O62', 'O67', 'N35', 'N32', 'B14', 'G52', 'B8', 'N36', 'O68', 'O74', 'I26', 'B3', 'B6', 'I25',
         'I17', 'N33', 'G47', 'O72', 'I28', 'B4', 'I27', 'I20', 'G59', 'I29', 'B1', 'N34', 'I24', 'N42','I16'
      ];
      let sequenceIndex = localStorage.getItem('sequenceIndex');
      if (sequenceIndex === null) {
        sequenceIndex = 0;
    ...
    const GenerateBingoNumber16 = () => {
      const sequence = [
        'O62', 'B7', 'N38', 'O61', 'G46', 'I17', 'O71', 'B10', 'N41', 'N40', 'B13', 'I26', 'G48', 'G54', 'O72',
        'I30', 'O75', 'G50', 'O67', 'O65', 'N31', 'N44', 'O64', 'G53', 'I19', 'O66', 'O73', 'I18', 'I29', 'N45',
        'G49', 'O68', 'O70', 'G60', 'N37', 'G56',  'O69', 'N43', 'G58', 'N42', 'B9', 'G57', 'G55', 'B11','O63',
        'B15', 'I22', 'I23', 'N35', 'N32', 'B14', 'G52', 'B8', 'N36', 'I21', 'O74', 'B5', 'B3', 'B6', 'I25',
         'B12', 'N33', 'G47', 'G51', 'I28', 'B4', 'I27', 'I20', 'G59', 'B2', 'N39', 'N34', 'I24', 'B1','I16'
      ];
      let sequenceIndex = localStorage.getItem('sequenceIndex');
      if (sequenceIndex === null) {
        sequenceIndex = 0;
    ...
    if (registeredNumbers.includes(parseInt(cardNumberInput)))  {
      ...
      switch (cardNumberInput) {
        ...
        case "37":
          ...
          case "51":
          navigate(
            `/card51?cardNumber=${cardNumberInput}&calledNumbers=${JSON.stringify(
              [...calledNumbers]
            )}`
          );
          break;
          case "52":
          navigate(
            `/card52?cardNumber=${cardNumberInput}&calledNumbers=${JSON.stringify(
              [...calledNumbers]
            )}`
          );
          break;
          case "53":
          navigate(
            `/card53?cardNumber=${cardNumberInput}&calledNumbers=${JSON.stringify(
              [...calledNumbers]
            )}`
          );
          break;
          case "54":
          navigate(
            `/card54?cardNumber=${cardNumberInput}&calledNumbers=${JSON.stringify(
              [...calledNumbers]
            )}`
          );
          break;
          case "55":
          navigate(
            `/card55?cardNumber=${cardNumberInput}&calledNumbers=${JSON.stringify(
              [...calledNumbers]
            )}`
          );
          break;
          case "56":
          navigate(
            `/card56?cardNumber=${cardNumberInput}&calledNumbers=${JSON.stringify(
              [...calledNumbers]
            )}`
          );
          break;
          case "57":
          navigate(
            `/card57?cardNumber=${cardNumberInput}&calledNumbers=${JSON.stringify(
              [...calledNumbers]
            )}`
          );
          break;
          case "58":
          navigate(
            `/card58?cardNumber=${cardNumberInput}&calledNumbers=${JSON.stringify(
              [...calledNumbers]
            )}`
          );
          break;
          case "59":
          navigate(
            `/card59?cardNumber=${cardNumberInput}&calledNumbers=${JSON.stringify(
              [...calledNumbers]
            )}`
          );
          break;
          case "60":
          navigate(
            `/card60?cardNumber=${cardNumberInput}&calledNumbers=${JSON.stringify(
              [...calledNumbers]
            )}`
          );
          break;
          case "61":
          navigate(
            `/card61?cardNumber=${cardNumberInput}&calledNumbers=${JSON.stringify(
              [...calledNumbers]
            )}`
          );
          break;
          case "62":
          navigate(
            `/card62?cardNumber=${cardNumberInput}&calledNumbers=${JSON.stringify(
              [...calledNumbers]
            )}`
          );
          break;
          case "63":
          navigate(
            `/card63?cardNumber=${cardNumberInput}&calledNumbers=${JSON.stringify(
              [...calledNumbers]
            )}`
          );
          break;
          case "64":
          navigate(
            `/card64?cardNumber=${cardNumberInput}&calledNumbers=${JSON.stringify(
              [...calledNumbers]
            )}`
          );
          break;
          case "65":
          navigate(
            `/card65?cardNumber=${cardNumberInput}&calledNumbers=${JSON.stringify(
              [...calledNumbers]
            )}`
          );
          break;
          case "66":
          navigate(
            `/card66?cardNumber=${cardNumberInput}&calledNumbers=${JSON.stringify(
              [...calledNumbers]
            )}`
          );
          break;
          case "67":
          navigate(
            `/card67?cardNumber=${cardNumberInput}&calledNumbers=${JSON.stringify(
              [...calledNumbers]
            )}`
          );
          break;
          case "68":
          navigate(
            `/card68?cardNumber=${cardNumberInput}&calledNumbers=${JSON.stringify(
              [...calledNumbers]
            )}`
          );
          break;
          case "69":
          navigate(
            `/card69?cardNumber=${cardNumberInput}&calledNumbers=${JSON.stringify(
              [...calledNumbers]
            )}`
          );
          break;
          case "70":
          navigate(
            `/card70?cardNumber=${cardNumberInput}&calledNumbers=${JSON.stringify(
              [...calledNumbers]
            )}`
          );
          break;
