...
const StartBingo = () => {
  ...
  useEffect(() => {
    ...
    if (selectedAmount === 10 && registeredNumbers.length <= 7) {
      ...
      selectedAmount === 10 &&
      registeredNumbers.length >= 8 &&
      registeredNumbers.length <= 10
    ) {
      setDeductedAmount(20);
    } else if (
      selectedAmount === 10 &&
      registeredNumbers.length >= 11 &&
      registeredNumbers.length <= 17
    ) {
      setDeductedAmount(30);
    } else if (
      selectedAmount === 10 &&
      registeredNumbers.length >= 18 &&
      registeredNumbers.length <= 22
    ) {
      setDeductedAmount(40);
    } else if (
      selectedAmount === 10 &&
      registeredNumbers.length >= 23 &&
      registeredNumbers.length <= 27
    ) {
      setDeductedAmount(50);
    } else if (
      selectedAmount === 10 &&
      registeredNumbers.length >= 28 &&
      registeredNumbers.length <= 31
    ) {
      setDeductedAmount(60);
    } else if (
      selectedAmount === 10 &&
      registeredNumbers.length >= 32 &&
      registeredNumbers.length <= 35
    ) {
      setDeductedAmount(70);
    } else if (
      selectedAmount === 10 &&
      registeredNumbers.length >= 36 &&
      registeredNumbers.length <= 38
    ) {
      setDeductedAmount(80);
    } else if (
      selectedAmount === 10 &&
      registeredNumbers.length >= 39 &&
      registeredNumbers.length <= 41
    ) {
      setDeductedAmount(90);
    } else if (
      selectedAmount === 10 &&
      registeredNumbers.length >= 42 &&
      registeredNumbers.length <= 45
    ) {
      setDeductedAmount(100);
    } else if (
      selectedAmount === 10 &&
      registeredNumbers.length >= 46 &&
      registeredNumbers.length <= 50
    ) {
      setDeductedAmount(110);
    } else if (
      selectedAmount === 10 &&
      registeredNumbers.length >= 51 &&
      registeredNumbers.length <= 55
    ) {
      setDeductedAmount(120);
    } else if (
      selectedAmount === 10 &&
      registeredNumbers.length >= 56 &&
      registeredNumbers.length <= 60
    ) {
      setDeductedAmount(130);
    } else if (
      selectedAmount === 10 &&
      registeredNumbers.length >= 61 &&
      registeredNumbers.length <= 65
    ) {
      setDeductedAmount(140);
    } else if (
      selectedAmount === 10 &&
      registeredNumbers.length >= 66 &&
      registeredNumbers.length <= 70
    ) {
      setDeductedAmount(150);
    } else if (
      selectedAmount === 10 &&
      registeredNumbers.length >= 71 &&
      registeredNumbers.length <= 75
    ) {
      setDeductedAmount(160);
    } else if (
      selectedAmount === 10 &&
      registeredNumbers.length >= 76 &&
      registeredNumbers.length <= 80
    ) {
      setDeductedAmount(170);
    } else if (
      selectedAmount === 10 &&
      registeredNumbers.length >= 81 &&
      registeredNumbers.length <= 85
    ) {
      setDeductedAmount(180);
    } else if (
      selectedAmount === 10 &&
      registeredNumbers.length >= 86 &&
      registeredNumbers.length <= 90
    ) {
      setDeductedAmount(190);
    } else if (
      selectedAmount === 10 &&
      registeredNumbers.length >= 91 &&
      registeredNumbers.length <= 95
    ) {
      setDeductedAmount(200);
    } else if (
      selectedAmount === 10 &&
      registeredNumbers.length >= 96 &&
      registeredNumbers.length <= 100
    ) {
      ...
      selectedAmount === 20 &&
      registeredNumbers.length >= 7 &&
      registeredNumbers.length <= 8
    ) {
      setDeductedAmount(30);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 9 &&
      registeredNumbers.length <= 11
    ) {
      setDeductedAmount(40);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 12 &&
      registeredNumbers.length <= 13
    ) {
      setDeductedAmount(50);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 14 &&
      registeredNumbers.length <= 15
    ) {
      setDeductedAmount(60);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 16 &&
      registeredNumbers.length <= 17
    ) {
      setDeductedAmount(70);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 18 &&
      registeredNumbers.length <= 19
    ) {
      setDeductedAmount(80);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 20 &&
      registeredNumbers.length <= 21
    ) {
      setDeductedAmount(90);
    } else if (
      selectedAmount === 20 &&
      ...
      selectedAmount === 20 &&
      registeredNumbers.length >= 24 &&
      registeredNumbers.length <= 25
    ) {
      setDeductedAmount(110);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 26 &&
      registeredNumbers.length <= 27
    ) {
      setDeductedAmount(120);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 28 &&
      registeredNumbers.length <= 29
    ) {
      setDeductedAmount(130);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 30 &&
      registeredNumbers.length <= 31
    ) {
      setDeductedAmount(140);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 32 &&
      registeredNumbers.length <= 33
    ) {
      setDeductedAmount(150);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 34 &&
      registeredNumbers.length <= 35
    ) {
      setDeductedAmount(160);
    } else if (
      ...
      selectedAmount === 20 &&
      registeredNumbers.length >= 42 &&
      registeredNumbers.length <= 43
    ) {
      setDeductedAmount(200);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 44 &&
      registeredNumbers.length <= 45
    ) {
      setDeductedAmount(210);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 46 &&
      registeredNumbers.length <= 47
    ) {
      setDeductedAmount(220);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 48 &&
      registeredNumbers.length <= 50
    ) {
      ...
      selectedAmount === 20 &&
      registeredNumbers.length >= 51 &&
      registeredNumbers.length <= 52
    ) {
      setDeductedAmount(240);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 53 &&
      registeredNumbers.length <= 55
    ) {
      ...
      selectedAmount === 20 &&
      registeredNumbers.length >= 56 &&
      registeredNumbers.length <= 57
    ) {
      setDeductedAmount(260);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 58 &&
      registeredNumbers.length <= 60
    ) {
      ...
      selectedAmount === 20 &&
      registeredNumbers.length >= 61 &&
      registeredNumbers.length <= 62
    ) {
      setDeductedAmount(280);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 63 &&
      registeredNumbers.length <= 65
    ) {
      ...
      selectedAmount === 20 &&
      registeredNumbers.length >= 66 &&
      registeredNumbers.length <= 67
    ) {
      setDeductedAmount(300);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 68 &&
      registeredNumbers.length <= 70
    ) {
      ...
      selectedAmount === 20 &&
      registeredNumbers.length >= 71 &&
      registeredNumbers.length <= 72
    ) {
      setDeductedAmount(320);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 73 &&
      registeredNumbers.length <= 75
    ) {
      ...
      selectedAmount === 20 &&
      registeredNumbers.length >= 76 &&
      registeredNumbers.length <= 77
    ) {
      setDeductedAmount(340);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 78 &&
      registeredNumbers.length <= 80
    ) {
      ...
      selectedAmount === 20 &&
      registeredNumbers.length >= 81 &&
      registeredNumbers.length <= 82
    ) {
      setDeductedAmount(360);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 83 &&
      registeredNumbers.length <= 85
    ) {
      ...
      selectedAmount === 20 &&
      registeredNumbers.length >= 86 &&
      registeredNumbers.length <= 87
    ) {
      setDeductedAmount(380);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 88 &&
      registeredNumbers.length <= 90
    ) {
      ...
      selectedAmount === 20 &&
      registeredNumbers.length >= 91 &&
      registeredNumbers.length <= 92
    ) {
      setDeductedAmount(400);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 93 &&
      registeredNumbers.length <= 95
    ) {
      ...
      selectedAmount === 20 &&
      registeredNumbers.length >= 96 &&
      registeredNumbers.length <= 97
    ) {
      setDeductedAmount(420);
    } else if (
      selectedAmount === 20 &&
      registeredNumbers.length >= 98 &&
      registeredNumbers.length <= 100
    ) {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.link}>
        <button onClickCapture={handleregisterClick} disabled={creatingReport}>
          RegisterCard
        </button>
        <button onClickCapture={handleReportClick} disabled={creatingReport}>
          Report
        </button>
        <button onClick={handleLogOut} disabled={creatingReport}>
          Logout
        </button>
      </div>
