...
import BingoCard from "../images/bingocard1.jpg";
...
const StartBingo = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <button onClick={handleLogOut}  disabled={creatingReport} className={styles.logout}>Logout</button>
      <button onClickCapture={handleReportClick} disabled={creatingReport} className={styles.report}>Report</button>
      </div>
      ...
      <div className={styles.cont2}>
          <button onClickCapture={handleregisterClick} disabled={creatingReport} className={styles.registercard}>RegisterCard</button>
