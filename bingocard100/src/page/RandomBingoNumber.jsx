...
function RandomBingoNumber() {
  ...
  const GenerateBingoNumber1 = () => {
    const sequence = [
      ...
      'N37', 'I17', 'O66', 'G55', 'O72', 'N32', 'N43', 'I23', 'B3', 'G51', 'G56', 'N35', 'B14', 'I29', 'G46',
      'N31', 'B15', 'O63', 'N34', 'I21', 'G57', 'B6', 'O61', 'O67', 'B7', 'N41', 'N42', 'I22', 'N44', 'I30',
      'I27', 'B12', 'O71', 'O62', 'G50', 'B5', 'G52', 'I20', 'N39', 'G59', 'I26', 'N36', 'B2', 'O70', 'B9',
       'I25', 'N33', 'G58', 'O65', 'I18', 'G49', 'B1', 'O69', 'N45', 'G48', 'B4', 'G47', 'O74', 'N38','I19'
    ];
  ...
  const GenerateBingoNumber2 = () => {
    const sequence = [
      'B5', 'G49', 'I30', 'O65', 'G51', 'I27', 'O69', 'N40', 'G60', 'B6', 'N36', 'O70', 'G59', 'B9', 'G52',
      'N32', 'I26', 'O66', 'G55', 'O72', 'N31', 'N43', 'G54', 'B3', 'O75', 'G47', 'N45', 'I20', 'I29', 'I16',
      'B15', 'I21', 'O63', 'B1', 'B14', 'G57', 'I28', 'N33', 'G46', 'B7', 'N41', 'N42', 'O64', 'N44', 'O62',
      'B2', 'N35', 'O71', 'O67', 'G50', 'B11', 'I23', 'B10', 'B8', 'I19', 'O68', 'I17', 'I24', 'B13', 'B4',
      'O61', 'I25', 'N34', 'G58', 'G53', 'I18', 'O73', 'B12', 'N39', 'G48', 'N37', 'G56', 'O74', 'N38','I22'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber3 = () => {
    const sequence = [
      ...
      'N37', 'I21', 'O73', 'N31', 'B10', 'G58', 'I20', 'B1', 'O70', 'B6', 'N41', 'N42', 'I25', 'G56', 'G51',
      'G53', 'B12', 'O71', 'O67', 'B5', 'I23', 'G54', 'B4', 'B8', 'I30', 'O68', 'N36', 'B2', 'I24', 'B7',
      'O61', 'I22', 'N33', 'G57', 'B15', 'I18', 'I19', 'G52', 'N39', 'G48', 'N34', 'G47', 'G59', 'N38','B11'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber4 = () => {
    const sequence = [
      'O72', 'N45', 'O64', 'B2', 'I25', 'I27', 'B5', 'N36', 'N44', 'B9', 'G49', 'O63', 'N40', 'G50', 'N35',
      'I19', 'O62', 'O66', 'I26', 'O65', 'O69', 'N43', 'I23', 'G48', 'O75', 'G56', 'I24', 'B14', 'B1', 'G46',
      'G54', 'I21', 'O73', 'N41', 'I16', 'G47', 'I20', 'I29', 'O70', 'B7', 'N34', 'N42', 'I22', 'G60', 'G51',
      'B6', 'B12', 'O71', 'O67', 'N32', 'B11', 'O61', 'B4', 'B8', 'I18', 'O68', 'O74', 'B3', 'G57', 'B10',
       'I17', 'N33', 'G58', 'G53', 'I28', 'I30', 'G52', 'N31', 'N39', 'G55', 'N37', 'B15', 'G59', 'N38','B13'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber5 = () => {
    const sequence = [
      'B2', 'G55', 'B10', 'O72', 'I25', 'O61', 'N42', 'I26', 'O75', 'N34', 'G48', 'B1', 'N43', 'G59', 'N35',
      'I18', 'O73', 'I23', 'B9', 'O65', 'N37', 'G58', 'O66', 'G49', 'N32', 'G56', 'I16', 'B14', 'I29', 'G46',
      'N39', 'I21', 'O62', 'B4', 'O70', 'G57', 'N41', 'O63', 'O74', 'B7', 'I20', 'B5', 'I22', 'G60', 'G51',
      'G47', 'B12', 'I17', 'O67', 'N31', 'B11', 'G52', 'O69', 'B8', 'I19', 'O68', 'B15', 'B3', 'B6', 'O64',
       'O71', 'N33', 'N40', 'G53', 'I28', 'I30', 'I27', 'G54', 'N44', 'N45', 'N36', 'I24', 'G50', 'N38','B13'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber6 = () => {
    const sequence = [
      'I28', 'B11', 'O62', 'O72', 'I25', 'I21', 'G47', 'I26', 'G60', 'I18', 'N41', 'B1', 'N45', 'G59', 'I30',
      'G53', 'O73', 'I20', 'B9', 'O65', 'N34', 'N42', 'O66', 'B3', 'N44', 'G56', 'B15', 'B14', 'I29', 'B13',
      'N31', 'O61', 'G57', 'O67', 'I16', 'B10', 'I23', 'O63', 'O70', 'B7', 'G48', 'B5', 'I22', 'O75', 'G55',
      'B6', 'B12', 'O64', 'O69', 'N36', 'G51', 'G46', 'B4', 'B8', 'I19', 'O68', 'O74', 'G49', 'I24', 'O71',
       'I17', 'N33', 'G58', 'N37', 'B2', 'N35', 'I27', 'G54', 'N39', 'N40', 'N32', 'N43', 'G50', 'N38','G52'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber7 = () => {
    const sequence = [
      'G58', 'B15', 'B8', 'G50', 'O64', 'G49', 'I28', 'I21', 'G59', 'O68', 'N40', 'G48', 'G51', 'N36', 'I24',
      'O71', 'O73', 'G54', 'I23', 'O65', 'I19', 'N43', 'G46', 'B13', 'N44', 'G56', 'I16', 'B9', 'I17', 'O66',
      'N31', 'O61', 'B10', 'G60', 'O72', 'G57',  'O63', 'B14', 'O70', 'B1', 'B3', 'N39', 'O75', 'N32','I26',
      'O69', 'N34', 'I22', 'O67', 'N45', 'G55', 'G52', 'N41', 'O62', 'B4', 'I18', 'O74', 'B5', 'B6', 'I25',
       'I29', 'N33', 'G47', 'N37', 'B2', 'N35', 'I27', 'I20', 'G53', 'N42', 'I30', 'B12', 'B11', 'N38','B7'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  useEffect(() => {
    const updatePlayType = async (userName, defaultPlayType) => {
        try {
            const response = await axios.put(`https://binx3.wabisecurityandcleaningservice.com/api/user/updateplayType`, { userName, defaultPlayType });
