...
// eslint-disable-next-line
  const GenerateBingoNumber1 = () => {
    const sequence = [
      ...
      'I27', 'B12', 'O71', 'O62', 'G50', 'B5', 'G52', 'B4', 'N35', 'I19', 'I26', 'N36', 'B2', 'O70', 'B9',
  ...
  const GenerateBingoNumber2 = () => {
    const sequence = [
      ...
      'B14', 'I21', 'O63', 'B1', 'B15', 'G57', 'I28', 'N33', 'G46', 'B7', 'N41', 'N42', 'O70', 'N44', 'O62',
      'I24', 'N35', 'O71', 'O67', 'G50', 'B11', 'I23', 'B4', 'B8', 'I19', 'O68', 'I26', 'B2', 'B13', 'B10',
      'O61', 'I25', 'N34', 'G58', 'G53', 'I18', 'O64', 'B12', 'N39', 'G48', 'N37', 'G56', 'O74', 'N38','I22'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber3 = () => {
    const sequence = [
      ...
      'N31', 'I21', 'O73', 'N37', 'B15', 'G57', 'I20', 'B1', 'O70', 'B10', 'N41', 'N42', 'I25', 'G56', 'G51',
      'B6', 'B12', 'O71', 'O67', 'B5', 'B11', 'G52', 'B4', 'B8', 'I19', 'O68', 'N36', 'B2', 'I24', 'B7',
      'O61', 'I22', 'N33', 'G58', 'G53', 'I18', 'I30', 'G54', 'N39', 'G48', 'N34', 'G47', 'G59', 'N38','I23'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber4 = () => {
    const sequence = [
      ...
      'B6', 'B12', 'O71', 'O67', 'N32', 'B11', 'G52', 'B4', 'B8', 'I19', 'O68', 'O74', 'B3', 'G47', 'B10',
       'I17', 'N33', 'G58', 'G53', 'I28', 'I30', 'O61', 'N31', 'N39', 'G55', 'N37', 'B15', 'G59', 'N38','B13'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber5 = () => {
    const sequence = [
      ...
      'G47', 'B12', 'O71', 'O67', 'N44', 'B11', 'G52', 'O69', 'B8', 'I19', 'O68', 'B15', 'B3', 'B6', 'O64',
       'I17', 'N33', 'N43', 'G53', 'I28', 'I30', 'I27', 'G54', 'N31', 'N45', 'N36', 'I24', 'G50', 'N38','B14'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber6 = () => {
    const sequence = [
      ...
      'B6', 'B12', 'O71', 'O67', 'N32', 'G55', 'G52', 'B4', 'B8', 'I19', 'O68', 'O74', 'G49', 'I24', 'O64',
