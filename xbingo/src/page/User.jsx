...
const updateBalance = async (userName) => {
  try {
    const response = await axios.put(`https://binx.mrxbingo.com/api/user/update`, { userName, newBalance });
  ...
  const updatePlayType = async (userName) => {
    try {
        const response = await axios.put(`https://binx.mrxbingo.com/api/user/updateplayType`, { userName, playType });
    ...
    useEffect(() => {
      const getReportsByUserName = async () => {
        try {
            const response = await axios.get(`https://binx.mrxbingo.com/api/report/${username}`);
    ...
    useEffect(() => {
        const fetchUser = async () => {
            try {
                const response = await axios.get(`https://binx.mrxbingo.com/api/user/${username}`);
    ...
    const handlePermissionUpdate = async () => {
        try {
            const response = await axios.put(`https://binx.mrxbingo.com/api/user/`, { userName: user.userName, permission:newPermission });
