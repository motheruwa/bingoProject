...
function RandomBingoNumber() {
  ...
  const GenerateBingoNumber9 = () => {
    const sequence = [
      ...
      'O75', 'B12', 'I22', 'G51', 'N32', 'O69', 'G52', 'B1', 'N36', 'O68', 'I30', 'O74', 'I17', 'B6', 'O67',
       'I25', 'B7', 'G47', 'N37', 'O71', 'N35', 'I27', 'I20', 'O64', 'G48', 'G49', 'N34', 'B4', 'N41','B3'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber10 = () => {
    const sequence = [
      ...
      'B1', 'B12', 'I22', 'B15', 'N34', 'O61', 'G52', 'N40', 'N36', 'B6', 'I20', 'O74', 'B13', 'I27', 'G58',
       'I17','I25', 'G47', 'N39', 'O71', 'N35', 'B4', 'I30', 'O64', 'B3', 'I24', 'N32', 'O68', 'N41','N33'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber12 = () => {
    const sequence = [
      ...
      'B15', 'O72', 'G58', 'G51', 'N32', 'O73', 'G56', 'B2', 'N36', 'B7', 'I30', 'O74', 'B3', 'B6', 'I18',
       'I25', 'N33', 'G47', 'O62', 'G57', 'B4', 'I27', 'I21', 'G54', 'B8', 'G52', 'N34', 'I17', 'N40','N37'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber13 = () => {
    const sequence = [
      ...
      'O63', 'O62', 'I22', 'N35', 'N32', 'B4', 'G52', 'B8', 'N44', 'B7', 'I30', 'O72', 'B3', 'B6', 'B11',
       'I25', 'N33', 'I17', 'O74', 'G57', 'B5', 'I27', 'I20', 'G54', 'B2', 'N39', 'N34', 'N36', 'N42','O61'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber15 = () => {
    const sequence = [
      ...
      'B15', 'O63', 'O67', 'N33', 'N32', 'B14', 'G52', 'B8', 'I29', 'O68', 'B3', 'I17', 'O74', 'B1', 'N42',
       'I25', 'N35', 'G47', 'O72', 'I28', 'B4', 'I27', 'I20', 'G59', 'N36', 'B6', 'N34', 'I24', 'I26','I16'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber16 = () => {
    const sequence = [
      ...
      'B12', 'I22', 'I23', 'N35', 'B3', 'B14', 'G52', 'I24', 'N36', 'I21', 'O74', 'B5', 'N32', 'I25', 'B4',
  ...
  const GenerateBingoNumber17 = () => {
    const sequence = [
      ...
      'B15', 'I22', 'I23', 'N40', 'N38', 'B14', 'G52', 'B8', 'G47', 'O75', 'B13', 'B5', 'B3', 'B6', 'B10',
       'B12', 'N33', 'N36', 'N45', 'O62', 'B4', 'O73', 'I20', 'G53', 'I19', 'N39', 'N34', 'N44', 'B9','I16'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber18 = () => {
    const sequence = [
      ...
      'B15', 'O73', 'I23', 'N40', 'N38', 'B14', 'I28', 'B2', 'B10', 'O75', 'I27', 'B5', 'B3', 'I25', 'O65',
       'B12', 'I21', 'G47', 'N45', 'N32', 'B4', 'N36', 'I20', 'B6', 'O71', 'N39', 'N34', 'N44', 'B9','I30'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber19 = () => {
    const sequence = [
      ...
      'B15', 'G54', 'B8', 'N40', 'N32', 'B14', 'N35', 'B2', 'G51', 'O75', 'I21', 'O70', 'B3', 'N44', 'G50',
       'B12', 'I27', 'N36', 'N45', 'B5', 'I17', 'B10', 'N37', 'G59', 'O71', 'G46', 'N34', 'B6', 'N42','I29'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber20 = () => {
    const sequence = [
      ...
      'B15', 'G54', 'I23', 'N40', 'N33', 'B14', 'I28', 'B2', 'N36', 'B13', 'I26', 'B5', 'B3', 'B6', 'G50',
       'B12', 'I27', 'G51', 'N45', 'O70', 'I21', 'B10', 'I20', 'G49', 'N39', 'G46', 'N34', 'B7', 'N42','O65'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber21 = () => {
    const sequence = [
      ...
      'O74', 'G54', 'I23', 'N40', 'N33', 'B14', 'I28', 'B2', 'N36', 'B8', 'G52', 'N45', 'B3', 'I22', 'N39',
       'B12', 'I21', 'G51', 'B5', 'O70', 'I26', 'B10', 'I20', 'B4', 'O65', 'N44', 'N34', 'N43', 'N42','G50'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber22 = () => {
    const sequence = [
      ...
      'O74', 'G54', 'I23', 'I16', 'N33', 'B14', 'I28', 'G55', 'N36', 'N37', 'I21', 'I26', 'G46', 'B9', 'O65',
       'B12', 'G52', 'G51', 'N45', 'N38', 'B5', 'B10', 'B2', 'B4', 'N39', 'O63', 'O68', 'N43', 'I22','G50'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber23 = () => {
    const sequence = [
      ...
      'I29', 'G47', 'N32', 'G56', 'N33', 'B14', 'I28', 'B11', 'N36', 'B13', 'B4', 'B5', 'N37', 'G46', 'G50',
       'B12', 'G52', 'G51', 'N45', 'I19', 'I26', 'B2', 'O71', 'N31', 'N39', 'O75', 'I22', 'N43', 'N42','O65'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber24 = () => {
    const sequence = [
      ...
      'O74', 'G54', 'N32', 'B10', 'N33', 'B7', 'I28', 'B2', 'N36', 'I20', 'I27', 'B5', 'G57', 'B1', 'N39',
       'O68', 'G52', 'G51', 'N45', 'I16', 'B14', 'I22', 'O71', 'B4', 'B15', 'N34', 'O69', 'I30', 'N42','G50'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber25 = () => {
    const sequence = [
      ...
      'G47', 'G54', 'N32', 'B10', 'N33', 'G57', 'I25', 'G46', 'B9', 'I20', 'G52', 'B5', 'G53', 'N35', 'B4',
      'B12', 'I16', 'G60', 'B13', 'B2', 'I21', 'B11', 'O71', 'O65', 'N39', 'N34', 'O62', 'N31', 'I26','G50'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber26 = () => {
    const sequence = [
      ...
      'O75', 'G54', 'N32', 'B8', 'N33', 'O63', 'I25', 'I17', 'N45', 'G59', 'I16', 'I28', 'O68', 'O69', 'O65',
       'B12', 'G52', 'G51', 'B13', 'G46', 'I21', 'B1', 'O71', 'B4', 'N36', 'B5', 'O62', 'N31', 'N42','I26'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber27 = () => {
    const sequence = [
      ...
      'O75', 'G54', 'N32', 'B3', 'N33', 'O63', 'I25', 'O70', 'N36', 'G59', 'I16', 'B7', 'N39', 'O69', 'O74',
       'B12', 'G52', 'B8', 'B5', 'G46', 'I21', 'B6', 'O71', 'B4', 'I29', 'N34', 'O65', 'B2', 'N42','G57'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber28 = () => {
    const sequence = [
      ...
      'O75', 'G54', 'N32', 'B8', 'B9', 'G53', 'I21', 'O70', 'N36', 'G52', 'N31', 'B5', 'N35', 'G47', 'O74',
       'B12', 'G59', 'G58', 'O68', 'G46', 'I25', 'B13', 'O71', 'B4', 'I29', 'B6', 'O65', 'B10', 'G51','G57'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber29 = () => {
    const sequence = [
      ...
      'G50', 'I20', 'O61', 'N45', 'N37', 'B15',  'O66', 'N43', 'O64', 'N41', 'I17', 'I23', 'G55', 'B11','G49',
      'O75', 'G54', 'N32', 'B8', 'B13', 'G53', 'G56', 'O70', 'N36', 'B10', 'N31', 'B5', 'B2', 'N34', 'O65',
       'B12', 'G52', 'G58', 'O68', 'G46', 'B7', 'B9', 'O71', 'B4', 'I29', 'N35', 'I24', 'B3', 'O63','B6'
    ];
    let sequenceIndex = localStorage.getItem('sequenceIndex');
    if (sequenceIndex === null) {
      sequenceIndex = 0;
  ...
  const GenerateBingoNumber30 = () => {
    const sequence = [
      ...
      'O75', 'G54', 'N32', 'N42', 'O74', 'G53', 'I19', 'O65', 'N36', 'B3', 'B14', 'B5', 'I21', 'N34', 'O70',
  ...
  useEffect(() => {
    const updatePlayType = async (userName, defaultPlayType) => {
        try {
            const response = await axios.put(`https://binx2.wabisecurityandcleaningservice.com/api/user/updateplayType`, { userName, defaultPlayType });
