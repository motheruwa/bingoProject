...
const StartBingo = () => {
  ...
  const handleClick = async () => {
    try {
      ...
      const response = await axios.put(
        `https://binx2.wabisecurityandcleaningservice.com/api/user/update`,
        { userName, newBalance }
      );
  ...
  const createReport = async () => {
    try {
      const response = await axios.post("https://binx2.wabisecurityandcleaningservice.com/api/report", {
        round: round,
