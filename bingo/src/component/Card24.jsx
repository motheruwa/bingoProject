...
function Card24() {
  ...
  const checkWin = () => {
    const winConditions = [
      ['B9', 'B8', 'B1', 'B7', 'B12'], // First row (B)
      ['I19', 'I26', 'I24', 'I20', 'I27'], // Second row (I)
      ['N40', 'N31', 'free', 'N39', 'N43'], // Third row (N)
      ['G46', 'G48', 'G59', 'G49', 'G57'], // Fourth row (G)
      ['O75', 'O67', 'O65', 'O70', 'O73'], // Fifth row (O)
